...
use ethcore::types::transaction;
use ethcore::types::transaction::{SignedTransaction, UnverifiedTransaction,
    Transaction, SignatureComponents, TypedTransaction};
...
use ethcore::pod_state::PodAccount;

use std::collections::{BTreeMap, HashMap, HashSet};

use ethcore::client::{EvmTestClient, EvmTestError, TransactErr, TransactSuccess};
...
lazy_static! {
    static ref SPEC: spec::Spec = ethereum::new_foundation(&String::new());
